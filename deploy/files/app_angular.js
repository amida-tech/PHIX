...
angular
  ...
  .run(['$rootScope', '$location', 'AuthenticationService', 'TabService', 'InboxService', function ($rootScope, $location, AuthenticationService) {
    ...
    var dev={phix_host:"{{ angular_dev_phix_host }}", phix_port:{{angular_dev_phix_port}}, clinician_host:"{{ angular_dev_clinician_host }}", clinician_port:{{angular_dev_clinician_port}}};
    var prod={phix_host:"{{ angular_prod_phix_host }}", clinician_host:"{{ angular_prod_clinician_host }}"};
