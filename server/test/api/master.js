...
describe('Master POST API', function () {  
  ...
  it('Test Demographics POST Approved', function(done) {
    ...
    .end(function(err, res) {
      ...
      if (res.body.demographics.length > 0) {
        ...
        .send({identifier: res.body.demographics[0].identifier, approved: true})
        .expect(200)
        .end(function(err, res) {
          if (err) return done(err);
          done();
  ...
  it('Test Demographics POST Archived', function(done) {
    ...
    .end(function(err, res) {
      ...
      if (res.body.demographics.length > 0) {
        api.post('/master/testUser/demographics')
        .send({identifier: res.body.demographics[0].identifier, archived: true})
        .expect(200)
        .end(function(err, res) {
          if (err) return done(err);
          done();
  ...
  it('Test Demographics POST Ignored', function(done) {
    ...
    .end(function(err, res) {
      ...
      if (res.body.demographics.length > 0) {
        api.post('/master/testUser/demographics')
        .send({identifier: res.body.demographics[0].identifier, ignored: true})
        .expect(200)
        .end(function(err, res) {
          if (err) return done(err);
          done();
  ...
  it('Test Allergies POST Approved', function(done) {
    ...
    .end(function(err, res) {
      ...
      if (res.body.allergies.length > 0) {
        ...
        .send({identifier: res.body.allergies[0]._id, approved: true})
        .expect(200)
        .end(function(err, res) {
          if (err) return done(err);
          done();
  ...
  it('Test Allergies POST Archived', function(done) {
    ...
    .end(function(err, res) {
      ...
      if (res.body.allergies.length > 0) {
        api.post('/master/testUser/allergies')
        .send({identifier: res.body.allergies[0]._id, archived: true})
        .expect(200)
        .end(function(err, res) {
          if (err) return done(err);
          done();
  ...
  it('Test Allergies POST Ignored', function(done) {
    ...
    .end(function(err, res) {
      ...
      if (res.body.allergies.length > 0) {
        api.post('/master/testUser/allergies')
        .send({identifier: res.body.allergies[0]._id, ignored: true})
        .expect(200)
        .end(function(err, res) {
          if (err) return done(err);
          done();
  ...
  it('Test Encounters POST Approved', function(done) {
    ...
    .end(function(err, res) {
      ...
      if (res.body.encounters.length > 0) {
        ...
        .send({identifier: res.body.encounters[0]._id, approved: true})
        .expect(200)
        .end(function(err, res) {
          if (err) return done(err);
          done();
  ...
  it('Test Encounters POST Archived', function(done) {
    ...
    .end(function(err, res) {
      ...
      if (res.body.encounters.length > 0) {
        api.post('/master/testUser/encounters')
        .send({identifier: res.body.encounters[0]._id, archived: true})
        .expect(200)
        .end(function(err, res) {
          if (err) return done(err);
          done();
  ...
  it('Test Encounters POST Ignored', function(done) {
    ...
    .end(function(err, res) {
      ...
      if (res.body.encounters.length > 0) {
        api.post('/master/testUser/encounters')
        .send({identifier: res.body.encounters[0]._id, ignored: true})
        .expect(200)
        .end(function(err, res) {
          if (err) return done(err);
          done();
  ...
  it('Test Immunizations POST Approved', function(done) {
    ...
    .end(function(err, res) {
      ...
      if (res.body.immunizations.length > 0) {
        ...
        .send({identifier: res.body.immunizations[0]._id, approved: true})
        .expect(200)
        .end(function(err, res) {
          if (err) return done(err);
          done();
  ...
  it('Test Immunizations POST Archived', function(done) {
    ...
    .end(function(err, res) {
      ...
      if (res.body.immunizations.length > 0) {
        api.post('/master/testUser/immunizations')
        .send({identifier: res.body.immunizations[0]._id, archived: true})
        .expect(200)
        .end(function(err, res) {
          if (err) return done(err);
          done();
  ...
  it('Test Immunizations POST Ignored', function(done) {
    ...
    .end(function(err, res) {
      ...
      if (res.body.immunizations.length > 0) {
        api.post('/master/testUser/immunizations')
        .send({identifier: res.body.immunizations[0]._id, ignored: true})
        .expect(200)
        .end(function(err, res) {
          if (err) return done(err);
          done();
  ...
  it('Test Results POST Approved', function(done) {
    ...
    .end(function(err, res) {
      ...
      if (res.body.results.length > 0) {
        ...
        .send({identifier: res.body.results[0]._id, approved: true})
        .expect(200)
        .end(function(err, res) {
          if (err) return done(err);
          done();
  ...
  it('Test Results POST Archived', function(done) {
    ...
    .end(function(err, res) {
      ...
      if (res.body.results.length > 0) {
        api.post('/master/testUser/results')
        .send({identifier: res.body.results[0]._id, archived: true})
        .expect(200)
        .end(function(err, res) {
          if (err) return done(err);
          done();
  ...
  it('Test Results POST Ignored', function(done) {
    ...
    .end(function(err, res) {
      ...
      if (res.body.results.length > 0) {
        api.post('/master/testUser/results')
        .send({identifier: res.body.results[0]._id, ignored: true})
        .expect(200)
        .end(function(err, res) {
          if (err) return done(err);
          done();
  ...
  it('Test Medications POST Approved', function(done) {
    ...
    .end(function(err, res) {
      ...
      if (res.body.medications.length > 0) {
        ...
        .send({identifier: res.body.medications[0]._id, approved: true})
        .expect(200)
        .end(function(err, res) {
          if (err) return done(err);
          done();
  ...
  it('Test Medications POST Archived', function(done) {
    ...
    .end(function(err, res) {
      ...
      if (res.body.medications.length > 0) {
        api.post('/master/testUser/medications')
        .send({identifier: res.body.medications[0]._id, archived: true})
        .expect(200)
        .end(function(err, res) {
          if (err) return done(err);
          done();
  ...
  it('Test Medications POST Ignored', function(done) {
    ...
    .end(function(err, res) {
      ...
      if (res.body.medications.length > 0) {
        api.post('/master/testUser/medications')
        .send({identifier: res.body.medications[0]._id, ignored: true})
        .expect(200)
        .end(function(err, res) {
          if (err) return done(err);
          done();
  ...
  it('Test Problems POST Approved', function(done) {
    ...
    .end(function(err, res) {
      ...
      if (res.body.problems.length > 0) {
        ...
        .send({identifier: res.body.problems[0]._id, approved: true})
        .expect(200)
        .end(function(err, res) {
          if (err) return done(err);
          done();
  ...
  it('Test Problems POST Archived', function(done) {
    ...
    .end(function(err, res) {
      ...
      if (res.body.problems.length > 0) {
        api.post('/master/testUser/problems')
        .send({identifier: res.body.problems[0]._id, archived: true})
        .expect(200)
        .end(function(err, res) {
          if (err) return done(err);
          done();
  ...
  it('Test Problems POST Ignored', function(done) {
    ...
    .end(function(err, res) {
      ...
      if (res.body.problems.length > 0) {
        api.post('/master/testUser/problems')
        .send({identifier: res.body.problems[0]._id, ignored: true})
        .expect(200)
        .end(function(err, res) {
          if (err) return done(err);
          done();
  ...
  it('Test Procedures POST Approved', function(done) {
    ...
    .end(function(err, res) {
      ...
      if (res.body.procedures.length > 0) {
        ...
        .send({identifier: res.body.procedures[0]._id, approved: true})
        .expect(200)
        .end(function(err, res) {
          if (err) return done(err);
          done();
  ...
  it('Test Procedures POST Archived', function(done) {
    ...
    .end(function(err, res) {
      ...
      if (res.body.procedures.length > 0) {
        api.post('/master/testUser/procedures')
        .send({identifier: res.body.procedures[0]._id, archived: true})
        .expect(200)
        .end(function(err, res) {
          if (err) return done(err);
          done();
  ...
  it('Test Procedures POST Ignored', function(done) {
    ...
    .end(function(err, res) {
      ...
      if (res.body.procedures.length > 0) {
        api.post('/master/testUser/procedures')
        .send({identifier: res.body.procedures[0]._id, ignored: true})
        .expect(200)
        .end(function(err, res) {
          if (err) return done(err);
          done();
  ...
  it('Test Vitals POST Approved', function(done) {
    ...
    .end(function(err, res) {
      ...
      if (res.body.vitals.length > 0) {
        ...
        .send({identifier: res.body.vitals[0]._id, approved: true})
        .expect(200)
        .end(function(err, res) {
          if (err) return done(err);
          done();
  ...
  it('Test Vitals POST Archived', function(done) {
    ...
    .end(function(err, res) {
      ...
      if (res.body.vitals.length > 0) {
        api.post('/master/testUser/vitals')
        .send({identifier: res.body.vitals[0]._id, archived: true})
        .expect(200)
        .end(function(err, res) {
          if (err) return done(err);
          done();
  ...
  it('Test Vitals POST Ignored', function(done) {
    ...
    .end(function(err, res) {
      ...
      if (res.body.vitals.length > 0) {
        api.post('/master/testUser/vitals')
        .send({identifier: res.body.vitals[0]._id, ignored: true})
        .expect(200)
        .end(function(err, res) {
          if (err) return done(err);
          done();
...
describe('Master Put API', function () {  
  ...
  it('Test Demographics Put', function(done) {
    ...
    .send({owner: testName, approved: true, archived: false, ignored: false, name: 'test'})
    .expect(200)
    .end(function(err, res) {
      if (err) return done(err);
      done();
  ...
  it('Test Allergies Put', function(done) {
    ...
    .send({owner: testName, approved: true, archived: false, ignored: false, name: 'test', status: 'active', severity: 'really bad'})
    .expect(200)
    .end(function(err, res) {
      if (err) return done(err);
      done();
