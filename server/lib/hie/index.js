  ...
  if (app.get("role") === "phix") {
    ...
    if (queryParameters.middlename) {
      queryJSON = {
        ...
        middlename: queryParameters.middlename,
        lastname: queryParameters.lastname,
        birthdate: queryParameters.birthdate
      };
    } else {
      queryJSON = {
        firstname: queryParameters.firstname,
    ...
    Personal.find(queryJSON, function(err, personalQueryResults) {
      ...
      if (personalQueryResults.length === 0) {
      ...
      function findAccount(personal, iter, callback) {
        ...
        }, function(err, accountQueryResults) {
          if (err) {
            throw err;
          }
